...
expression
  : expression '+' INT_NUM { char* str = strdup($1); strcat(str, $2); strcat(str, add_expr_tag($3)); $$ = str;}
  | expression '-' INT_NUM {}
  | expression '*' INT_NUM {}
  | expression '/' INT_NUM {}
...
idents
  ...
  | ident '=' expression { char* str = strdup($1); strcat(str, $2); strcat(str, $3); $$ = str; printf("%s", str);}
  | ident { $$ = $1;}
;
