...
%type<string_v> array_decl arrays array arr_dim arr_contents arr_content exprs
...
arr_contents
  ...
  | arr_content ',' arr_contents
    {
      char *str = strdup($1);
      strcat(str, itoa($2)); strcat(str, $3);
      $$ = str;
    }
;
