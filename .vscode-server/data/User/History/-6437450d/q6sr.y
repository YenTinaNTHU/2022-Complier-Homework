...
expression
  : expression '+' INT_NUM { char* str = strdup($1); strcat(str, $2); strcat(str, $3); $$ = str; }
  | expression '-' INT_NUM { char* str = strdup($1); strcat(str, $2); strcat(str, $3); $$ = str; }
  | expression '*' INT_NUM { char* str = strdup($1); strcat(str, $2); strcat(str, $3); $$ = str; }
  | expression '/' INT_NUM { char* str = strdup($1); strcat(str, $2); strcat(str, $3); $$ = str; }
  | INT_NUM { char str[]; strcpy(str, "<expr>");  strcat(str, $1); strcat(str, "</expr>"); $$ = str; }
;
...
idents
  ...
  | ident '=' expression { char* str = strdup($1); strcat(str, $2); strcat(str, $3); $$ = str;  printf("%s\n",$$);}
  | ident { $$ = $1; printf("%s\n",$$);}
;
