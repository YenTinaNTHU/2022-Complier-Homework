...
expression
  : expression '+' INT_NUM { char* str = strdup($1); strcat(str, $2); strcat(str, $3); $$ = str; printf("test(%s)",str);}
  | expression '-' INT_NUM { char* str = strdup($1); strcat(str, $2); strcat(str, $3); $$ = add_expr_tag(str); }
  | expression '*' INT_NUM { char* str = strdup($1); strcat(str, $2); strcat(str, $3); $$ = add_expr_tag(str); }
  | expression '/' INT_NUM { char* str = strdup($1); strcat(str, $2); strcat(str, $3); $$ = add_expr_tag(str); }
