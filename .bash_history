...
cd hw1
ls
cp ./sample_testcase.txt ../../108000208
cd ~
ls
cd h1
cd hw1
...
claer
clear
sample_testcase.txt > golden_scanner
golden_scanner < sample_testcase.txt 
script.sh < sample_testcase.txt 
sh script.sh < sample_testcase.txt
sh script.sh
sh script.sh < sample_testcase.txt
cd hw1
sh script.sh < sample_testcase.txt
...
make clean
make
./scanner < sample_testcase.txt
make
ls
make
./scanner < sample_testcase
./scanner < sample_testcase.txt
sh test.sh
make clean
make
...
cd testcase
ls
cp ./hw1 ../108000208/hw1/ans
cp -r ./hw1 ../108000208/hw1/ans
cd ../108000208/hw1
sh test.sh
cd hw1
sh test.sh
...
git rm --cached .wget-hsts
git rm --cached .profile
git rm -r --cached .gitconfig
git rm -r --cached .bashrc
git rm -r --cached .bash_history
git rm -r --cached .vscode-server
git rm -r --cached .vim
git rm -r --cached .gnupg
