...
{
       0,    38,    38,    45,    49,    56,    60,    67,    76,    88,
      75,   100,   101,   105,   106,   110,   119,   131
};
#endif
...
static const char *const yytname[] =
{
  ...
  "CHAR4", "CHAR8", "DOUBLE", "VOID", "FLOAT", "STRUCT", "RETURN",
  "LSHIFT", "RSHIFT", "STR", "NUL", "FOR", "DO", "WHILE", "BREAK",
  "CONTINUE", "IF", "ELSE", "SWITCH", "CASE", "DEFAULT", "CHAR_START",
  "CHAR_END", "ESCAPE_START", "ESCAPE_CHAR", "STRING_START", "STRING_END",
  "CODEGEN", "DIGITALWRITE", "DELAY", "HIGH", "LOW", "$accept", "program",
  "program_ingredients", "program_ingredient", "codegen_decl",
  "codegen_def", "$@1", "$@2", "codegen_stmts", "codegen_stmt",
  "digital_write_func", "delay_func", YY_NULLPTR
};
#endif
...
{
     -49,   -70,     8,   -49,   -77,   -77,   -77,   -28,   -77,   -77,
     -27,   -32,   -77,   -77,   -77,   -76,   -25,   -24,   -30,   -77,
     -77,   -77,    11,    12,   -77,   -17,   -21,   -75,   -14,   -19,
     -18,   -77,   -11,   -10,   -77,   -77
};
...
{
      12,    16,    17,     1,    29,    30,     7,    13,     8,    10,
      24,    11,    22,    23,    25,    26,    27,    28,    31,    32,
      33,    34,    35,     9
};

static const yytype_uint8 yycheck[] =
{
      32,    77,    78,    52,    79,    80,    76,    39,     0,    37,
      40,    38,    37,    37,     3,     3,    33,    38,    32,    38,
      38,    32,    32,     3
};
...
{
       0,    52,    82,    83,    84,    85,    86,    76,     0,    84,
      37,    38,    32,    39,    87,    89,    77,    78,    88,    90,
      91,    92,    37,    37,    40,     3,     3,    33,    38,    79,
      80,    32,    38,    38,    32,    32
};
...
{
       0,    81,    82,    83,    83,    84,    84,    85,    87,    88,
      86,    89,    89,    90,    90,    91,    91,    92
};
